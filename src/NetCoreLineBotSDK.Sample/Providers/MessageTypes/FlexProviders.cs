...
{
    public class FlexMessageProvider : IReplyIntent
    {
        ...
        {
            var json = GetFlexTemplate();
            
            var msg = new FlexMessage(json);
        ...
        private string GetFlexTemplate()
        {
            var layout = @"
{
  'type': 'bubble',
...
";
            layout = layout.Replace("{{title}}", ".NET Core Cafe");
            return layout;
        }
    }
}
